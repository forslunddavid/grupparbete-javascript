...
function createWinOverlay() {
    ...
    winContent.innerText =
        "Grattis du vann! Du gissade " + guessedLetters.length + " gånger";
...
function createLoseOverlay() {
    ...
    loseContent.innerText =
        "Tyvärr du förlorade! Det rätta order var: " + randomValue;
...
document.addEventListener("keydown", (event) => {
    ...
    if (letters.includes(guessedLetter)) {
        ...
        if (
            correctWordAsArray.includes(guessedLetter) &&
